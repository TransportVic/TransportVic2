    ...
    tripsAffected.forEach(trip => {
      ...
      if (firstHalfStops.length) {
        let firstTrip = {
          ...
          destinationArrivalTime: firstHalfStops.slice(-1)[0].arrivalTime,
      ...
      if (busReplacement.length) {
        let busTrip = {
          ...
          destinationArrivalTime: busReplacement.slice(-1)[0].arrivalTime,
      ...
      if (secondHalfStops.length) {
        let secondTrip = {
          ...
          destinationArrivalTime: secondHalfStops.slice(-1)[0].arrivalTime,
