...
describe('The MTM Rail Bus Tracker', () => {
  it('Should create a trip updater object', async () => {
    ...
    expect(tripData[0].stops[0].estimatedArrivalTime.toISOString()).to.equal('2025-07-08T06:04:27.000Z')
    expect(tripData[0].stops[0].estimatedDepartureTime.toISOString()).to.equal('2025-07-08T06:04:27.000Z')
  })
})