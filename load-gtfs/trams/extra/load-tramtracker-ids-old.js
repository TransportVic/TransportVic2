...
database.connect({}, async err => {
  ...
  await updateStats('tramtracker-ids-old', filteredTramtrackerStops.length)
  console.log('Completed loading in ' + filteredTramtrackerStops.length + ' tramtracker IDs using old method')
  process.exit()
})
